...
test('readOnly test: template readOnly - true should override readOnly generated by components', () => {
    let tmpTemplate = { ...textField1 };
    tmpTemplate.readOnly = true;
    wrapper = mount(
        <div>
            <Form
                onChange={() => { }}
...
test('readOnly test: template readOnly - false', () => {
    let tmpTemplate = { ...textField1 };
    tmpTemplate.readOnly = false;
    wrapper = mount(
        <div>
            <Form
                onChange={() => { }}
